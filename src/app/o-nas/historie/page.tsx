export const metadata = {
  title: "Historie | ČRS MO Týn nad Vltavou",
};
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <div className="prose prose-green prose-lg max-w-none text-gray-600">
            ...
            <p>
              <strong>Rok 1925 byl velmi smutným rokem.</strong> Řeka se změnila v pohřebiště ryb v důsledku obrovské katastrofy. I drsní voraři tehdy stáli na břehu a plakali. Od té doby začal spolek více spolupracovat s ostatními, aby získal zkušenosti v ochraně vod.
            </p>
            <p>
            ...
            <p>
              Po roce 1945 zahájila MO (nyní pod Zemským rybářským svazem) obrovské obnovovací práce. Od roku 1947 byla zavedena pracovní povinnost a stovky brigádnických hodin byly odpracovány při stavbě nových rybníků (např. u Lišků, Fišerák).
            </p>
            
            <h3>Temné období otrav a ztráta Týnských jezů</h3>
            <p>
              V 80. letech došlo k masivním otravám Vltavy a přítoků kvůli průmyslu a zemědělství. Konec desetiletí pak přinesl dostavbu vodního díla Kořensko a Hněvkovice (1991).
            </p>
            <p>
              <strong>Největší ztráta a kouzlo Vltavy bylo zcela dokonáno rozbořením třech Týnských jezů.</strong> Navždy byla umlčena píseň zpívajících jezů, které provázely Týn staletími.
            </p>

            <h3>Nová éra a poděkování</h3>
            <p>
              V roce 1995 MO znovu vybojovala do péče "svůj" úsek pod označením Vltava 20 (od Kořenska po Hněvkovice). O pár let později přibyla Lužnice 1.
            </p>
            <p>
              V roce 1999 ukončil po 45 letech svou neuvěřitelnou práci ve funkci předsedy pan <strong>Václav Srnec</strong>. Tento text nemůže zachytit tisíce jmen obětavých lidí, ale všem, kteří věnovali svou energii naší organizaci, patří hluboké poděkování.
            </p>
            <p className="mt-12 text-center italic font-semibold text-green-700">
              S přáním mnoho pevného zdraví, krásných zážitků u vody a bohatých úlovků!<br />
